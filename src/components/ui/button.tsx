...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-lg font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[#15cb89] text-white hover:bg-[#12b578]',
        destructive: 'bg-red-500 text-white hover:bg-red-600',
        outline: 'border border-[#E5E7EB] bg-white hover:bg-gray-50 text-gray-700',
        ghost: 'hover:bg-gray-100 text-gray-700',
        link: 'text-[#15cb89] underline-offset-4 hover:underline',
        orange: 'bg-[#ff8401] text-white hover:bg-[#e07501]',
        darkBlue: 'bg-[#132c64] text-white hover:bg-[#0f2251]',
      },
      size: {
